...
var (
	pkg       = flag.String("assert-path", "github.com/pytlesk4/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/pytlesk4/testify/_codegen
